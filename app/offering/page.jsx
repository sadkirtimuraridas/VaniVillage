export default function OfferingPage() {
  return (
    <main className="min-h-screen bg-black text-gray-100 flex items-center justify-center p-8">
      <div className="max-w-3xl rounded-2xl bg-gradient-to-tr from-black/60 to-white/5 p-10 ring-1 ring-white/5">
        <h1 className="text-3xl font-bold mb-4"><br/><br/>Śrīla Prabhupāda's Disappearance Offering</h1><br/>
...
Please allow us to satisfy your desires, as we have never satisfied your desires before.<br/><br/>
...
And just for today, Śrīla Prabhupāda, <br/>
...
Just for today, Srila Prabhupada, <br/>
...
Please allow us to reciprocate with you, as we have never reciprocated with you before. <br/><br/>
...
<br/><br/>
 ...
 And dear Śrīla Prabhupāda,<br/>

Please bless us so that every day can be today.<br/><br/>

<span style={{ color: "deepskyblue" }}>
<b>Devotees:</b></span> Haribol! Outside is a big blessing of a beautiful rainbow.

<br/><br/>
<span style={{ color: "lightgreen" }}>
<b>Visnu Murti:</b></span> Is it?
...
<br/><br/>
<span style={{ color: "lightgreen" }}>
<b>Visnu Murti:</b> </span> So, we're hoping that talented and committed devotees will come and spend time here (at the Vani Village) and help Vanipedia go to another level. Vanipedia is no longer young. For 18 years, we've been building Vanipedia. We still have a long way to go. It's a little bit like a current generation staying at home until they're 30. There was a generation where they left home when they were 15 and 16, right? But now this generations they stay at home longer. So Vanipedia is also a little bit, still a little child, hasn't grown up completely. So maybe Vanipedia, when it turns 30, it can say that it's offered some real seva to humanity, to the devotees.<br/><br/>
...
<br/><br/>
<span style={{ color: "deepskyblue" }}>
<b>Devotees:</b></span> Visnu Murti prabhu ki! Jaya!

<br/><br/>
<span style={{ color: "lightgreen" }}>
<b>Visnu Murti:</b></span> You want to do a little bhajan as they go? You want to? Oh, five minutes.
<br/><br/>
<span style={{ color: "deepskyblue" }}>
<b>Devotees:</b></span> Laksmipriya mataji ki! Jaya!

<br/><br/>
<span style={{ color: "lightgreen" }}>
<b>Visnu Murti:</b></span> Yeah, don't forget Laksmipriya.
<br/><br/>
        ...
        <div>
          <a
            href="/"
            className="inline-block rounded-md bg-white/10 px-4 py-2 text-white hover:bg-white/20"
          >
            Back to Home
          </a>
        </div>
